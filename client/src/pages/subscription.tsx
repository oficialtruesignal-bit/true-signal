      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Gerencie seu plano Ocean Prime</p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          {!isPremium && (
            ...
            >
              ...
              {isExpired ? "Renovar Assinatura" : "Assinar Ocean Prime"}
            </Button>
          )}
